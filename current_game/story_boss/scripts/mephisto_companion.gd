...
const SOURCES = [preload("res://story_boss/assets/mephisto/demon_detailed28.glb"), preload("res://story_boss/assets/mephisto/demon_older24.glb")]
...
func _ready() -> void:
    ...
    for i in 2:
        ...
        material.shader = preload("res://story_boss/scripts/mephisto_shadow.gdshader")
        ...
        form.visible = i == 0
    warm_wisps = preload("res://story_boss/scripts/mephisto_wisps.gd").new()
