...
signal eliminated(fighter: CharacterBody3D)
...
func _ready() -> void:
    ...
    if character_id in preload("res://scripts/humanoid_air_side.gd").VIEWS:
        ...
        if character_id == "mephisto":
            ...
            humanoid_air_side = preload("res://story_boss/scripts/mephisto_air_side.gd").new()
            humanoid_air_basic = preload("res://story_boss/scripts/mephisto_air_basic.gd").new()
    ...
    if character_id in ["teknium", "turbofit"]:
        ...
        add_child(hurtboxes)
    if character_id == "mephisto":
        mephisto_moves = preload("res://story_boss/scripts/mephisto_moves.gd").new()
        mephisto_moves.name = "MephistoMoves"
        add_child(mephisto_moves)
        var paired_hurtboxes = preload("res://story_boss/scripts/mephisto_paired_hurtboxes.gd").new()
...
func _build_visuals() -> void:
    ...
    if character_id == "mephisto":
        for placeholder in _visual_root.get_children():
            _visual_root.remove_child(placeholder)
            placeholder.queue_free()
        var mephisto_visual = preload("res://story_boss/scripts/mephisto_visual.gd").new()
