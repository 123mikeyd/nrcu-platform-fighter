...
static func display_name(id: String) -> String:
    return {"teknium": "Teknium", "doge_man": "Doge Man", "ggb": "GGB", "turbofit": "Turbofit", "ice_mage": "Ice Mage", "witcheer": "Witcheer", "mephisto": "Mephisto", "bobo": "Bobo (Prototype)"}.get(id, "Unknown")
