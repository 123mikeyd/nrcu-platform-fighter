...
func show_page(next: String):
    ...
    if next == "home":
        add_button("Play", "play", 354, func():
            get_tree().auto_accept_quit = true
            get_tree().change_scene_to_file("res://scenes/main.tscn"))
        add_button("How to Play", "help", 434, func(): show_page("help"))
        add_button("Quit", "quit", 514, func(): show_page("quit"))
    else:
        add_button("Stay here", "home", 354, func(): show_page("home"))
        add_button("Quit", "exit", 434, func(): get_tree().quit())
