...
func run():
    for id in ["doge_man", "teknium", "turbofit", "ggb", "ice_mage", "fire_mage"]:
    ...
    var file = FileAccess.open("res://.verification/evidence/electrocution_roster/coverage_runtime.json",FileAccess.WRITE)
